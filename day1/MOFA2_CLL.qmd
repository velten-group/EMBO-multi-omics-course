...
For some of the correlation analysis in the following, we want to treat `sex`\footnote{*Gender* is a sociological concept, *sex* a biological. While they are relatex, in analyses such as here we usually care more about the latter.} and `died` as numeric variables, and hence we create these here. 
